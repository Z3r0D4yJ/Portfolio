    ...
    <section id="experience" className="mb-20 scroll-mt-20">
      ...
      {EXPERIENCE.map((entry) => (
        <FadeIn key={entry.title + entry.date}>
          <div className="grid grid-cols-1 md:grid-cols-[120px_1fr] gap-1 md:gap-6 py-5 pl-6 border-l border-border relative mb-1 cursor-default group hover:bg-[rgba(0,255,136,0.03)] hover:border-l-accent transition-colors duration-200">
            {/* timeline dot */}
            ...
            <div>
              <div className="text-[15px] font-semibold text-text mb-1">{entry.title}</div>

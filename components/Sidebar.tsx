...
import { GithubLogo, LinkedinLogo, PaperPlaneTiltIcon  } from '@phosphor-icons/react/dist/ssr'
import { Nav } from './Nav'
...
function GitBookIcon() {
  return (
    <svg width={22} height={22} viewBox="0 0 65 65" fill="currentColor" aria-hidden>
...
function SocialIcon({ type }: { type: SocialLink['type'] }) {
  ...
  switch (type) {
    ...
    case 'gitbook':  return <GitBookIcon />
  }
}
